...
const Produtos = (() => {
    ...
    function render() {
        ...
        if (!list.length) {
            tbody.innerHTML = `<tr><td colspan="8"><div class="empty-state"><i class="fa-solid fa-cookie-bite"></i>Nenhum produto cadastrado.</div></td></tr>`;
            return;
        }
                ...
                <td>
                    <div style="display:flex;align-items:center;gap:10px;">
                        <div style="width:34px;height:34px;border-radius:9px;background:var(--orange-50);display:flex;align-items:center;justify-content:center;overflow:hidden;flex-shrink:0;">
                            ${p.imagemUrl ? `<img src="${p.imagemUrl}" style="width:100%;height:100%;object-fit:cover;">` : '<i class="fa-solid fa-cookie-bite" style="color:var(--orange-500);"></i>'}
                        </div>
