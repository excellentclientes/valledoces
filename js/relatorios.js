...
const Relatorios = (() => {
    ...
    function mount() {
        ...
        el.innerHTML = `
            ...
            <div class="kpi-row">
                ...
                <div class="kpi-box"><div class="lbl">Doces vendidos</div><div class="val" id="rel-doces">0</div></div>
            </div>
            <div class="grid-2">
                <div class="panel">
    ...
    function render() {
        ...
        box.innerHTML = arr.length ? arr.map(([nome, qtd], idx) => `
            ...
            </div>`).join('') : `<div class="empty-state"><i class="fa-solid fa-cookie-bite"></i>Sem vendas no período.</div>`;
    ...
    function exportCsv() {
        ...
        a.download = `valle-doces-relatorio-${dateFrom}_a_${dateTo}.csv`;
        a.click();
